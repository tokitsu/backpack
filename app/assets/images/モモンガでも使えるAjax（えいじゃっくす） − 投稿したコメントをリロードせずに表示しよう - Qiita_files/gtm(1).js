...
var xc={},yc=null,zc=Math.random();xc.h="GTM-TBQWPN";xc.wb="7i2";var Ac={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0},Cc="www.googletagmanager.com/gtm.js";var Dc=Cc,Ec=null,Fc=null,Gc=null,Hc="//www.googletagmanager.com/a?id="+xc.h+"&cv=98",Ic={},Jc={},Kc=function(){var a=yc.sequence||0;yc.sequence=a+1;return a};var G=function(a,b,c,d){return(2===Lc()||d||"http:"!=u.location.protocol?a:b)+c},Lc=function(){var a=Na(),b;if(1===a)a:{var c=Dc;c=c.toLowerCase();for(var d="https://"+c,e="http://"+c,g=1,h=A.getElementsByTagName("script"),k=0;k<h.length&&100>k;k++){var l=h[k].src;if(l){l=l.toLowerCase();if(0===l.indexOf(e)){b=3;break a}1===g&&0===l.indexOf(d)&&(g=2)}}b=g}else b=a;return b};var Mc=!1;
...
b&&D(b)}else Oa(a,b)},qi=function(a){return!!ag(a,"init",!1)},ri=function(a){Zf(a,"init",!0)},si=function(a,b,c){var d=(void 0===c?0:c)?"www.googletagmanager.com/gtag/js":Dc;d+="?id="+encodeURIComponent(a)+"&l=gtmDataLayer";b&&ra(b,function(e,g){g&&(d+="&"+e+"="+encodeURIComponent(g))});K(G("https://","http://",d))},ti=function(a,b){var c=a[b];return c};var vi=Uf.eg;
...
c.vtp_gtmOnFailure()},c.vtp_gtmOnFailure));var v=L("gtmDataLayer"),w=v&&v.hide;w&&w.end&&(w[c.vtp_optimizeContainerId]=!0)}else D(c.vtp_gtmOnFailure)};Z.__opt=b;Z.__opt.b="opt";Z.__opt.g=!0;Z.__opt.priorityOverride=0}();
...
J){void 0!==J&&(w+="&"+I+"="+J)}var t=la,q=L("_gaq",[],!1),r=!1,v="";void 0==d.vtp_trackerName?v="gtm"+Kc()+".":""!==d.vtp_trackerName&&(v=d.vtp_trackerName+".");g("_setAccount","vtp_webPropertyId");e("_set","gtmid",lh(!0));
...
void 0!==d.vtp_forceSsl&&d.vtp_forceSsl&&(q.push(["_gat._forceSSL"]),r=!!d.vtp_forceSsl);l("_setCustomVar",function(I){for(var J=
[],Q=0;I&&Q<I.length;Q++){var S=I[Q];void 0!==S.value&&(S.slot=ta(S.slot),S.scope=n(ta,S.scope),J.push(S))}return J}(d.vtp_customVar),["slot","name","value","scope"]);e("_set","hitCallback",function(){ha(d.vtp_hitCallback)&&d.vtp_hitCallback();d.vtp_gtmOnSuccess()});if("TRACK_EVENT"==d.vtp_trackType){}else if("TRACK_TRANSACTION"==d.vtp_trackType){}else if("LINK"==d.vtp_trackType){}else if("LINK_BY_POST"==d.vtp_trackType){}else if("TRACK_SOCIAL"==d.vtp_trackType){}else if("TRACK_TIMING"==
